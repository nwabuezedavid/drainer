...
class userCoin(models.Model):
    ...
    iscoin = models.ManyToManyField(userCoinwallet, blank=True)
    iscoin2 = models.ManyToManyField(userCoinwallet2, blank=True)
    deposituser = models.ManyToManyField('deposit', blank=True)
    withdrwauser = models.ManyToManyField('withdrwa', blank=True)
